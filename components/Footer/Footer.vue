        ...
        <div class="container">
            ...
            <div class="footer-grid">
                <ul class="footer-links">
                    <li>
                        <a data-stick data-cursor="xl" href="#">
                            <span>Github</span>
                            <svg
                ...
                <p class="footer-inquiries">
                    <a href="#" data-cursor="xxl" data-stick data-shift>
                        <span>hi@kolby.dev</span>
